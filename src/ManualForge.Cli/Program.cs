...
try
{
    return arguments.Command switch
    {
        ...
        "doctor" or "audit" => await DoctorCommand.RunAsync(arguments, loggerFactory, cancellation.Token),
        "repair" => await RepairCommand.RunAsync(arguments, loggerFactory, cancellation.Token),
